...
\newcommand{\qvaeBlank}[0]{q (\cdot \mid \vect{x})}
...
\newcommand{\fkmMonteCarlo}[0]{f_k^m({\ztk^m}^{(l)},{\zt^m}^{(l)})}


\newcommand{\gim}[0]{\log \frac{\fkm }{\sum_{\zj^m \in X} f_k^m(\zj^m, \zt^m)}}

\newcommand{\gimMonteCarlo}[0]{\log \frac{\fkmMonteCarlo}{\sum_{\zj^m \in X} f_k^m(\zj^m, {\zt^m}^{(l)})}}



\newcommand{\R}[0]{\mathbb{R}}

\newcommand{\qzzblank}[0]{q^m(\cdot \mid \zt^{m-1})}

\newcommand{\latentspaceconstraintgim}[0]{\kl{ \qzzblank }{ \standardnormal } }

\newcommand{\sampleqdot}[1]{q(\cdot \mid #1)}
\newcommand{\sampleqmdot}[1]{q^m(\cdot \mid #1)}
\newcommand{\sampleqMOnedot}[1]{q^{M+1}(\cdot \mid #1)}

\newcommand{\reconstrgim}[0]{\sum_k
\expected{
	\sample{\ztk^m}{\sampleqmdot{\ztk^{m-1}} } \\ 
	\sample{\zt^m}{\sampleqmdot{\zt^{m-1}}} } 
\left[ \gim \right]
}

\newcommand{\reconstrgimMontecarlo}[0]{\sum_k
%	\expected{
%		\sample{\ztk^m}{\sampleqmdot{\ztk^{m-1}} } \\ 
%		\sample{\zt^m}{\sampleqmdot{\zt^{m-1}}} } 
	\frac{1}{L} 
	\left[\sum_{l=1}^L \gimMonteCarlo \right]
}
...
\newcommand{\qfromzmneg}[0]{\sampleqmdot{\zt^{m-1}}}
\newcommand{\qfromzm}[0]{\sampleqmdot{\zt^m}}
\newcommand{\qfromzM}[0]{\sampleqMOnedot{\zt^M}}
