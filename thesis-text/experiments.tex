...
\section{V-GIM's Interpretability analysis} 
	...
	\begin{figure}
		...
		\caption{Visualisation of V-GIM's latent space where dimension 0 and 16 are being perturbed and the other dimensions remain fixed at 0. These two dimensions weer}
