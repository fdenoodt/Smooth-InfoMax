\chapter{Discussion and future work} \label{cha:6}
% scribbr:
...
In this thesis, we introduced V-GIM, a self-supervised approach for interpretable representation learning through mutual information maximisation. In this chapter, we provide a discussion of V-GIM's results with respect to its interpretability. We discuss its limitations and make recommendations for plausible future work.
...
% benefits and representation variability}
