...
\subtitle{Towards indepdenent and interpratable representations}
...
\subtitle{[Dutch] Towards indepdenent and interpratable representations}
...
\newcommand{\expected}[1]{\mathbb{E}_{#1}}
...
\newcommand{\latentspaceconstraint}[0]{\kl{ \qphizx }{ \pz } }

\newcommand{\latentspaceconstraintstandardgaussian}[0]{\kl{ \qphizx }{ \standardnormal } }
...
xx does what \cite{lowePuttingEndEndtoEnd2020} yes!
idk \cite{coverELEMENTSINFORMATIONTHEORY} cool


\bibliographystyle{IEEEtran}
\bibliography{ThesisSync}
