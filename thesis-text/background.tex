...
\begin{figure}
	...
	\caption{ Latent space of autoencoder (left) and VAE (right), learned from the MNIST dataset \cite{PapersCodeMNIST}, a dataset consisting of images of handwritten digits between 0 and 9. The ANNs have not received any explicit information of the labels of the dataset. 
...
%[L]
	...
	\begin{figure}
		\hspace{2cm}
		\centering
		\input{graphs/cpc_single_module}
...
\subsubsection{Towards greedy learning}	
	...
	\begin{figure}[h!t]
		\hspace{2cm}
		\input{graphs/gim_multiple_modules}
